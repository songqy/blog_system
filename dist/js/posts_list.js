...
var _login_register = __webpack_require__(34);
...
var list = new _main.Vue({
    ...
    methods: {
        post_detail: function post_detail(id) {
            location.href = "./post_detail.html?id=" + id;
        },
        modify_post: function modify_post(id) {
        ...
        delete_post: function () {
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                _context2.next = 4;
                                return (0, _posts.deletePost)(this.$http, id);
            ...
            function delete_post(_x) {
                return _ref2.apply(this, arguments);
            }

            return delete_post;
        }(),
        get_posts_by_page: function () {
            ...
            function get_posts_by_page(_x2) {
                return _ref3.apply(this, arguments);
            }

            return get_posts_by_page;
        }(),
        fetchData: function () {
            var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(pageSize, page) {
                var data, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, item, tag_ids, tags, v, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, tag_id, tag;
                ...
                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                _context4.next = 2;
                                return (0, _posts.getPostsByUser)(this.$http, pageSize, page);
                            ...
                            case 8:
                                ...
                                _context4.prev = 17;
                                _iterator2 = tag_ids[Symbol.iterator]();
                            ...
                            case 19:
                                ...
                                tag_id = _step2.value;
                                _context4.next = 23;
                                return (0, _tag.getTagById)(v, tag_id);
                ...
                }, _callee4, this, [[6, 49, 53, 61], [17, 30, 34, 42], [35,, 37, 41], [54,, 56, 60]]);
            }));
...
var login_register = (0, _login_register2.default)();
...
exports.updatepassword = exports.user_logout = exports.user_register = exports.user_login = undefined;

//登录
var user_login = function () {
    var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(v, name, password) {
        var success;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
    ...
    return function user_login(_x, _x2, _x3) {
        return _ref.apply(this, arguments);
    };
}();
...
var user_register = function () {
    var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(v, name, password) {
        var success;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
    ...
    return function user_register(_x4, _x5, _x6) {
        return _ref2.apply(this, arguments);
    };
}();
...
var user_logout = function () {
    ...
    return function user_logout(_x7) {
        return _ref3.apply(this, arguments);
    };
}();

var updatepassword = function () {
    var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(v, password, new_password) {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
            while (1) {
                switch (_context4.prev = _context4.next) {
                    case 0:
                        password = (0, _sha2.default)(password);
                        new_password = (0, _sha2.default)(new_password);
                        _context4.next = 4;
                        return v({
...
var _sha = __webpack_require__(325);
...
/* WEBPACK VAR INJECTION */(function(Buffer) {(function() {
  var crypt = __webpack_require__(322),
      utf8 = __webpack_require__(319).utf8,
      bin = __webpack_require__(319).bin,
...
exports.default = function () {
    return new _main.Vue({
        ...
        methods: {
                    ...
                    return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                            switch (_context.prev = _context.next) {
                                ...
                                case 3:
                                    _context.next = 5;
                                    return (0, _users.user_login)(this.$http, this.user_name, this.user_password);
                    ...
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                            switch (_context2.prev = _context2.next) {
                                ...
                                case 3:
                                    _context2.next = 5;
                                    return (0, _users.user_register)(this.$http, this.user_name, this.user_password);
            ...
            click_name: function click_name() {
            ...
            logout_click: function logout_click() {
                var c = confirm("确定退出！");
                if (c) {
                    (0, _users.user_logout)(this.$http);
                }
            },
            set_up_click: function set_up_click() {
